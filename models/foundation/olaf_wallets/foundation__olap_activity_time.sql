...
txns AS (
    select 
    signer_id,
    account.block_timestamp AS account_created_date
...
activity_by_time as (
    ...
    LEFT JOIN olap_account_owner as account ON fact_actions_events.SIGNER_ID = olap_account_owner.SIGNER_ID
    group by 1
)
